...
export default class CreateTellerPage {
  ...
  firstRecord : "//span[@class='oj-fwk-icon-dots-vertical oj-fwk-icon summary-action-btn']",
   ...
   lovBranch: "(//input[@class='oj-inputtext-input oj-text-field-input oj-component-initnode'])[43]",
    ...
    MinBal: "(//input[@class='oj-inputtext-input oj-text-field-input oj-component-initnode'])[54]",
    MaxBal:"(//input[@class='oj-inputtext-input oj-text-field-input oj-component-initnode'])[55]",
    currency1:"(//input[@aria-label='Please select the value for Currency Code'])[2]",
    MaxTransamnt: "(//input[@class='oj-inputtext-input oj-text-field-input oj-component-initnode'])[58]",
    AuthTransamnt:"(//input[@class='oj-inputtext-input oj-text-field-input oj-component-initnode'])[59]"
  };
  async NextGenFun() {
...
async selectBranchLov(branch: string) {
    ...
    const branchInput = newPage.locator('//*[@id="_oj252-lov-search|input"]');
...
async selectUserLov(userId: string) {
    const branchInput = newPage.locator('//*[@id="_oj253-lov-search|input"]');
  ...
  await newPage.locator(
     ...
     await newPage.locator('//*[@id="_oj256-input-text|input"]').fill(min)
    // await newPage.locator(
    //     "fsgbu-ob-cmn-fd-amount input[aria-required='true']" +
    //     ":not([disabled]):not([readonly])"
  ...
  async addCurrencyLimitPreference(curr: string, maxTxn: string, auth: string) {
   ...
   await newPage.waitForTimeout(2000)
   await newPage.locator('//*[@id="_oj259-input-text|input"]').fill(maxTxn);
