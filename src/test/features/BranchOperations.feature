...
@BranchOps1 @SBM1 @openBranchBatchAndTellerBatch
...
@BranchOps2 @SBM1 @OpenVaultandTill @tdUserIdchangeandTillType
  ...
  Given User navigates to the application
   ...
   And user selects NextGen UI Dashboard and select Retail Operations
    ...
    Then user validates authorization success
     ...
     Examples:
      | HomePageTitle                                       |   Status    |SearchName      |    status1        | BranchCode | UserId   | TillType | CH_Currency | MinBal | MaxBal           | CL_Currency | MaxTxnAmt | AuthLimit     |Status1    |BranchName|
    |  Oracle Financial Services                              | Unauthorized  | Branch User Limits| Authorized   |*.*       | PREPROD1  |Till    |KES         | 0    | 9,999,999,999.00| KES   | 5,000.00   | 9,999,999.00    |Unauthorized| 100     |
     |  Oracle Financial Services                              | Unauthorized  | Branch User Limits| Authorized   |*.*       | PREPROD1  |Vault   |KES         | 0    | 9,999,999,999.00| KES   | 5,000.00   | 9,999,999.00    |Unauthorized| 100     |
 
    @BranchOps3 @SBM1 @TillToVaultandVaultToTill @tdUserIdandTillTypeandTillTypechange
 ...
 Examples:
      | HomePageTitle                                       |SearchName      |    status1        |TillType1| BranchCode | UserId   | TillType | CH_Currency | MinBal | MaxBal           | CL_Currency | MaxTxnAmt | AuthLimit     |Status1    |BranchName|
    |  Oracle Financial Services                             | Branch User Limits| Authorized       |Vault    |*.*       | CLPMAUTO8  | Till    |KES         | 0.00    | 9,999,999,999.00| KES   | 5,000.00   | 9,999,999.00    |Unauthorized| 100     |
     |  Oracle Financial Services                             | Branch User Limits| Authorized       |Till    |*.*       | CLPMAUTO8  |Vault  |KES         | 0.00    | 9,999,999,999.00| KES   | 5,000.00   | 9,999,999.00    |Unauthorized| 100     |
