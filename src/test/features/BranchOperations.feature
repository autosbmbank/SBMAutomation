...
@BranchOps2 @SBM1 @OpenVaultandTill @tdUserIdchangeandTillType
  ...
  Given User navigates to the application
   ...
   And user selects NextGen UI Dashboard and select Retail Operations 
    ...
    |  Oracle Financial Services                              | Unauthorized  | Branch User Limits| Authorized       |Vault    |*.*       | ATESTER4   | Vault    |KES         | 0    | 9,999,999,999.00| KES   | 5,000.00   | 9,999,999.00    |Unauthorized| 100     |
 ...
 Examples:
    ...
    # |  Oracle Financial Services                              | 999        | AUTO     | AUTOUSER      | 100        | Enable |DEC 03, 2025  | ENG      | 100     | OBBRN_MANAGER        |100  | OBBRN_BASE    | PLATO | REMO | OBPY | DEPOSIT | LOAN | Unauthorized  | Branch User Limits| Authorized       |Vault    |*.*       | CLPMAUTO8  | Till    |KES         | 0.00    | 9,999,999,999.00| KES   | 5,000.00   | 9,999,999.00    |Unauthorized| 100     |
     |  Oracle Financial Services                              | 999        | AUTO     | AUTOUSER      | 100        | Enable |DEC 03, 2025  | ENG      | 100     | OBBRN_MANAGER        |100  | OBBRN_BASE    | PLATO | REMO | OBPY | DEPOSIT | LOAN | Unauthorized  | Branch User Limits| Authorized       |Till    |*.*       | ATESTER7 | Vault    |KES         | 0.00    | 9,999,999,999.00| KES   | 5,000.00   | 9,999,999.00    |Unauthorized| 100     |