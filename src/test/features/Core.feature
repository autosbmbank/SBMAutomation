...
Feature: Core Module Feature
   ...
   |  Oracle Financial Services                                             | 100          | STDCIF     | Test2    | UAT12     | CIND                | Male   | 7/4/1999  | KE             | Kenya           | KE   | ENG      | MER       | MAIL  |999      |Joint Customer    |GEDCULIK   |
   # | Oracle Financial Services - ENG - Transaction Input | 100          | STDCIF       | Test2    | UAT12     | STAFF      | Male   | 2000-03-03  | LS          | Maseru, Lesotho | LS      | ENG      | LRB      | MAIL  |999      |Joint Customer    |GEDCULIK   |
      ...
      @CORE2 @CIFcreationforIndividualTrackLimitsUncheck
        ...
        Examples:
                  ...
                  | Oracle Financial Services                       | 100          | STDCIF       |Corporate    | Test2    | UAT12     | CCRP    | Male   | 2000-03-03  |Ke         | Kenya | KE    | ENG      | MER     | MAIL  |999      |
